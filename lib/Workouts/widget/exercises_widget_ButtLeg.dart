...
import 'package:perfect_body/Workouts/data/exercises_sets_ButtLeg.dart';
...
class ExercisesWidgetButtLeg extends StatefulWidget {
  @override
  _ExercisesWidgetButtLegState createState() => _ExercisesWidgetButtLegState();
}

class _ExercisesWidgetButtLegState extends State<ExercisesWidgetButtLeg> {
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ButtLeg()),
                        );
                      },
                    ),
                    Positioned(
