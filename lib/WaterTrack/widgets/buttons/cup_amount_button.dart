...
import 'package:perfect_body/WaterTrack/global_blocs/drink_bloc.dart';
import 'package:perfect_body/WaterTrack/utils/asset_util.dart';
import 'package:perfect_body/WaterTrack/widgets/popups/custom_amount_popup.dart';
...
class CupAmountButton extends StatelessWidget {
  ...
  void setCustomAmount(DrinkBloc drinkBloc, BuildContext context) {
    showDialog(
      ...
      builder: (context) {
        return CustomAmountPopup(drinkBloc: drinkBloc);
      },
    );
  }
