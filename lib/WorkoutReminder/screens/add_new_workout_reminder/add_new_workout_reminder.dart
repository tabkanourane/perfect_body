...
import 'package:perfect_body/WorkoutReminder/database/repository.dart';
import 'package:perfect_body/WorkoutReminder/helpers/snack_bar.dart';
...
import 'package:perfect_body/WorkoutReminder/notifications/notifications.dart';
import 'package:perfect_body/WorkoutReminder/screens/add_new_workout_reminder/form_fields.dart';
import '../../helpers/platform_flat_button.dart';
import 'workout_reminder_type_card.dart';
import 'package:timezone/data/latest.dart' as tz;
import 'package:timezone/timezone.dart' as tz;

class AddNewReminderWorkout extends StatefulWidget {
  @override
  _AddNewReminderWorkoutState createState() => _AddNewReminderWorkoutState();
}

class _AddNewReminderWorkoutState extends State<AddNewReminderWorkout> {
  ...
  final List<WorkoutReminderType> medicineTypes = [
    WorkoutReminderType("Full Body", Image.asset("assets/FullBody.jpg"), true),
    WorkoutReminderType("Butt & Leg", Image.asset("assets/ButtLeg.jpg"), false),
    WorkoutReminderType("Abs & Arm", Image.asset("assets/AbsArm.jpg"), false),
    WorkoutReminderType("Fitness", Image.asset("assets/fitness.jpg"), false),
            ...
            children: [
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...medicineTypes.map(
                        (type) => WorkoutReminderTypeCard(type, medicineTypeClick))
                  ],
                ),
              ),
              SizedBox(
  ...
  Future savePill() async {
    ...
    if (setDate.millisecondsSinceEpoch <=
      ...
      //create pill object
      Pill pill = Pill(
          amount: descriptionController.text,
  ...
  void medicineTypeClick(WorkoutReminderType medicine) {
    setState(() {
